...
HD_PWD='P:/18summer/engs031/G19/Etch-a-Sketch/Etch-a-Sketch.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_shell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_level_shell.tcl
