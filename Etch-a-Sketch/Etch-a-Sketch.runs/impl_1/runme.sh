...
HD_PWD='P:/18summer/engs031/G19/Etch-a-Sketch/Etch-a-Sketch.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_level_shell.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_level_shell.tcl -notrace
