...
#
# Generated by Vivado on Tue Aug 21 22:38:18 -0400 2018
...
# Script info
echo -e "Block_Ram.sh - Script generated by export_simulation (Vivado v2017.3.1 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot Block_Ram xil_defaultlib.Block_Ram -log elaborate.log
}
