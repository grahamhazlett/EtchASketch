...
HD_PWD='P:/18summer/engs031/G19/VGA Test/VGA Test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_Shell.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_Shell.tcl
