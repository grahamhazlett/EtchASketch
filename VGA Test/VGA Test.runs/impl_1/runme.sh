...
HD_PWD='P:/18summer/engs031/G19/VGA Test/VGA Test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_Shell.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_Shell.tcl -notrace
